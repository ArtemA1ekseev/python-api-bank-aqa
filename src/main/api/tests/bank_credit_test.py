...
class TestBankCredit:
    ...
    def test_account_credit_request_valid(
        ...
        user_request = logged_credit_user_with_account.user_request
        id_account = logged_credit_user_with_account.account.id

        response_credit_request = CreateCreditRequest(accountId=id_account, amount=credit_amount, termMonths=term_months)
        response_create_credit = api_manager.user_steps.credit_request(user_request, response_credit_request)
        ...
        credit_history = api_manager.user_steps.credit_history(user_request)
        ...
        account_transactions = api_manager.user_steps.get_transactions(user_request, id_account)
    ...
    def test_account_credit_request_invalid_second_credit_while_active(
        ...
        user_request = logged_credit_user_with_two_accounts.user_request
        id_account_first = logged_credit_user_with_two_accounts.first_account.id
        id_account_second = logged_credit_user_with_two_accounts.second_account.id

        response_credit_request_first = CreateCreditRequest(accountId=id_account_first, amount=5000, termMonths=12)
        api_manager.user_steps.credit_request(user_request, response_credit_request_first)

        response_credit_request_second = CreateCreditRequest(accountId=id_account_second, amount=5000, termMonths=12)
        api_manager.user_steps.credit_request_invalid(user_request, response_credit_request_second)
    ...
    def test_account_credit_repay_valid(
        ...
        response_credit_repay = api_manager.user_steps.credit_repay(user_request, credit_repay_request)
    ...
    def test_account_credit_repay_invalid_partial_amount(
        ...
        api_manager.user_steps.credit_repay_invalid(user_request, credit_repay_request)
